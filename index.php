...
<html lang="<?=$language;?>">
  <head>
    ...
    <script type="module" crossorigin src="./assets/index.618c2214.js"></script>
    <link rel="stylesheet" href="./assets/index.e29fe129.css">
  ...
  <body class="font-sans antialiased">
    ...
    <script nomodule id="vite-legacy-polyfill" src="./assets/polyfills-legacy.a37ff6d1.js"></script>
    <script nomodule id="vite-legacy-entry" data-src="./assets/index-legacy.a6fdec25.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>